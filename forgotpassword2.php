    ...
    <div class="row" id="loginRow">
        ...
        <div class="col-6 col-12-sm border backgroundw"  id="form">
            ...
            <form class="container" id="formForPass" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post" name="forgotPassword">
                <div class="row">
                    <input type="password" class="col-12 col-12-sm input shadowhover" id="passwordForPass" name="passwordForPass" placeholder="New Password"required>
                </div>
                <div class="row">
                    <input type="password" class="col-12 col-12-sm input shadowhover" id="confirmPasswordForPas" name="confirmPasswordForPass" placeholder="Confirm Password" required>
                </div>
                <div class="row">
